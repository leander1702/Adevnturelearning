...
const Header = () => {
  return (
    <header
  className="text-white py-3 px-6 flex flex-col sm:flex-row justify-between items-center"
  style={{ backgroundColor: '#0057D3' }}
>
  <div className="text-xs mb-3 sm:mb-0 flex flex-wrap justify-center sm:justify-start">
