...
function CourseLink() {
  return (
    <>
      ...
      <div className="flex items-center justify-center bg-[#F5F5F5] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
    ...
    data-aos-duration="1400" className="text-center hover:text-black">Development</li>
      ...
      {/* Divider Line */}
      <div className="flex justify-center bg-[#F5F5F5] py-4 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
