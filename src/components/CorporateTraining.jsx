      ...
      <div className="bg-gray-100">
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* On Premises */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:border-2 hover:border-[#0057D3] hover:shadow-lg hover:scale-105">
              <div className="w-16 h-16 flex items-center justify-center text-[#0057D3] text-3xl mb-4">
                <img src={train1} className="w-12 h-12" alt="On Premises Training" />
              </div>
              <h3 className="text-lg font-semibold text-gray-700 mb-2 text-center">On Premises</h3>
              <p className="text-gray-600 text-center">Get training at your location, tailored to your team’s needs.</p>
            </div>

            {/* Online Instructor Led */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:border-2 hover:border-[#0057D3] hover:shadow-lg hover:scale-105">
              <div className="w-16 h-16 flex items-center justify-center text-[#0057D3] text-3xl mb-4">
                <img src={train2} className="w-14 h-14" alt="Online Instructor Led Training" />
              </div>
              <h3 className="text-lg font-semibold text-gray-700 mb-2 text-center">Online Instructor Led</h3>
              <p className="text-gray-600 text-center">Interactive online training with live instructors, from anywhere.</p>
            </div>

            {/* Self Paced */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:border-2 hover:border-[#0057D3] hover:shadow-lg hover:scale-105">
              <div className="w-16 h-16 flex items-center justify-center text-[#0057D3] text-3xl mb-4">
                <img src={train3} className="w-14 h-14" alt="Self Paced Training" />
              </div>
              <h3 className="text-lg font-semibold text-gray-700 mb-2 text-center">Self Paced</h3>
              <p className="text-gray-600 text-center">Learn at your own pace, anytime, anywhere, with flexible courses.</p>
            </div>

            {/* Blended */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:border-2 hover:border-[#0057D3] hover:shadow-lg hover:scale-105">
              <div className="w-16 h-16 flex items-center justify-center text-[#0057D3] text-3xl mb-4">
                <img src={train4} className="w-14 h-14" alt="Blended Training" />
              </div>
              <h3 className="text-lg font-semibold text-gray-700 mb-2 text-center">Blended</h3>
              <p className="text-gray-600 text-center">A mix of both online and in-person training for maximum flexibility.</p>
            </div>
          </div>
        </div>
      </div>
